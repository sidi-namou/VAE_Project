...
#define RTC_SPI_CLOCK_SOURCE DSPI1_CLK_SRC
/* Definition of the clock source frequency */
#define RTC_SPI_CLK_FREQ CLOCK_GetFreq(RTC_SPI_CLOCK_SOURCE)
...
/* Definition of the clock source */
#define DSPI_2_CLOCK_SOURCE DSPI2_CLK_SRC
/* Definition of the clock source frequency */
#define DSPI_2_CLK_FREQ CLOCK_GetFreq(DSPI_2_CLOCK_SOURCE)
//ADC1_SE12
#define ADC0_PTB6 12U
#define ADC0_PTB6_GROUP 0U
#define BatterySupply 23.4;// 12V la tension de la batterie par hypothese
/***********************************************************************************************************************
 * Global variables
 **********************************************************************************************************************/
...
float PuissanceMoye(float newCurrent);
float PuissanceInst(float newCurrent);
float EnergieConsom(float newCurrent);
/***********************************************************************************************************************
